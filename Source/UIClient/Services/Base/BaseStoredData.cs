...
namespace UIClient.Services.Base
{
    public class BaseStoredData<T> : IStoredDataService<T> where T: class, new()
    {
        public BaseStoredData(string folderName, string fileNameFormat)
        {
